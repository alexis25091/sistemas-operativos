...
/* Analsis del codigo 1: Este código simula la gestión de páginas en memoria física mediante una estructura de frames y emplea el algoritmo 
FIFO (First-In, First-Out) para reemplazar páginas cuando la memoria está llena. */
